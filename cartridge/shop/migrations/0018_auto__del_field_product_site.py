...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Product.site'
        raise RuntimeError("Cannot reverse this migration. 'Product.site' and its values cannot be restored.")
    ...
    models = {
        ...
        'generic.keyword': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'generic_keyword_related'", 'symmetrical': 'False', 'to': "orm['sites.Site']"}),
        ...
        'pages.page': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'pages_page_related'", 'symmetrical': 'False', 'to': "orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
        ...
        'shop.product': {
            ...
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'shop_product_related'", 'symmetrical': 'False', 'to': "orm['sites.Site']"}),
